            ...
            if pa==p:
                ...
                if c == 1:
                    ...
                    if ans == 4:
                        ...
                        print("SORRY! YOU ENTER A INVALID OPTION. PLEASE ENTER A VALID ONE ")
                ...
                if c== 3:
                    ...
                    if s in range (0,10):
                        ...
                        print("Hurray!! huhu...",n,"you have given all correct answers")
                import mysql.connector as sa
                a_s=sa.connect(host="localhost",user="root",password=" ",database="asd")
                sad=a_s.cursor()
                name=n
                scr=s
                d=(name,scr)
